...
case Rails.env
  when 'development'
    ...
    Evaluation.create!(user_id: user1.id, course_id: full_course.id, rating: 5, description: 'Super Kurs!', course_status: :finished, rated_anonymously: false, total_feedback_count: 101, positive_feedback_count: 101, creation_date: '2015-05-29 13:56:03.19532', update_date: '2015-06-11 13:59:55.148811')
