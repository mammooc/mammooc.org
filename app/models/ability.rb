...
class Ability
  ...
  def initialize(user)
    ...
    can [:update, :destroy, :invite_group_members, :add_administrator, :demote_administrator, :remove_group_member, :all_members_to_administrators, :synchronize_courses, 
        :initial_passwords, :reset_member_password], Group do |group|
