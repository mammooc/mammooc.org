...
class UserEmail < ActiveRecord::Base
  ...
  def is_autogenerated?
    autogenerated = false
    UserIdentity.where(user: user).each do |identity|
     autogenerated = true if ("autogenerated@#{identity.provider_user_id}-#{identity.omniauth_provider}.com".match(address)).present?
    end
    autogenerated
  end
