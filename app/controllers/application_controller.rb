...
class ApplicationController < ActionController::Base
  ...
  def ensure_signup_complete
    ...
    # email hasn't been saved
    return unless current_user && (UserEmail.find_by(user: current_user, is_primary: true).is_autogenerated? || current_user.password_autogenerated)
    session_infos = {}
    session_infos[:primary_email] = current_user.primary_email unless UserEmail.find_by(user: current_user).is_autogenerated?
