...
class ApplicationController < ActionController::Base
  ...
  def ensure_signup_complete
    ...
    return unless current_user
    return unless current_user.primary_email_autogenerated? || current_user.full_name_autogenerated?

    session_infos = {}
    session_infos[:full_name] = current_user.full_name unless current_user.full_name_autogenerated?
  ...
  def set_language
    ...
    locale = session[:language] if session[:language] && I18n.available_locales.include?(session[:language].to_sym)
