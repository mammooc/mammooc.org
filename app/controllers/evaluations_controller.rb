  ...
  def login_and_save
    ...
    if current_user.blank?
      if mooc_provider.oauth_path_for_login.blank?
        ...
        redirect_post mooc_provider.oauth_path_for_login + '?' + params.to_unsafe_hash.to_param, options: { authenticity_token: :auto, autosubmit_nonce: content_security_policy_script_nonce }
      end
    else
      provider_course_id = params['course_id']
