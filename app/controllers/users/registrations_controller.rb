  ...
  class RegistrationsController < Devise::RegistrationsController
    ...
    def create
      ...
      if resource.persisted? && user_params.key?(:terms_and_conditions_confirmation) && exception.blank?
        ...
        session_infos = {}
        session_infos['first_name'] = sign_up_params[:first_name] || session[:resource]['first_name']
        session_infos['last_name'] = sign_up_params[:last_name] || session[:resource]['last_name']
        session_infos['primary_email'] = sign_up_params[:primary_email] || session[:resource]['primary_email']
