...
describe UdacityCourseWorker do
  let!(:mooc_provider) { FactoryBot.create(:mooc_provider, name: 'Udacity') }
  ...
  let!(:free_course_track_type) { FactoryBot.create :course_track_type, type_of_achievement: 'udacity_nothing' }
  let!(:certificate_course_track_type) { FactoryBot.create :certificate_course_track_type, type_of_achievement: 'udacity_verified_certificate' }
