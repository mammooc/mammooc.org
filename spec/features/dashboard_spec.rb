...
RSpec.describe DashboardController, :type => :feature do
  ...
  describe 'display enrolled courses' do
    it 'should show newly enrolled course after synchronization request', js: true do
    ...
    it 'should remove a currently enrolled course after synchronization request', js: true do
      FactoryGirl.create(:mooc_provider_user, user: user, mooc_provider: mooc_provider, authentication_token: '123')
