...
RSpec.describe User, type: :model do
  ...
  describe 'factories' do
    ...
    it 'allows to create a valid user without email address' do
      user = FactoryGirl.create(:noEmailUser)
      expect(user).to be_valid
      expect(UserEmail.find_by(user: user, is_primary: true).autogenerated?).to eql false
  ...
  describe 'primary_email_autogenerated?' do
    ...
    it 'response false if primary_email is not autogenerated' do
      ...
      expect(user.primary_email_autogenerated?).to eql false
    end

    it 'response true if the primary_email is autogenerated' do
      expect(user.primary_email_autogenerated?).to eql true
    end
  end
